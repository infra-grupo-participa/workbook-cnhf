...
<template>
  <div class="shell">
    ...
    <section class="hero card">
      ...
      <p class="muted">Seu acesso ao workbook do Curso Nacional de Formação em Holding Familiar está garantido. Abra o caderno abaixo e acompanhe as aulas preenchendo capítulo a capítulo.</p>
      <div class="tags">
    ...
    <!-- WORKBOOK — caderno de acompanhamento das aulas -->
    <section class="card wb">
      <div class="wb-icon"><BookOpen :size="26" :stroke-width="2" /></div>
      <div class="eyebrow">Material do curso</div>
      <h2>Workbook — caderno de acompanhamento</h2>
      <p class="muted">
        Acompanhe as aulas do Curso Nacional de Formação em Holding Familiar preenchendo
        o workbook capítulo a capítulo. Seu progresso é salvo automaticamente — você pode
        fechar e continuar de onde parou.
      </p>
      <button class="btn primary" style="margin-top:18px" @click="router.push({ name: 'workbook' })">
        Abrir meu workbook
      </button>
    </section>
  </div>
...
/* card do workbook */
.wb { padding: 32px 32px 30px; }
.wb-icon { width: 58px; height: 58px; margin-bottom: 14px; border-radius: 14px; background: var(--accent-soft); border: 1px solid var(--accent-line); display: grid; place-items: center; color: var(--accent); }
.wb h2 { font-size: 22px; margin: 8px 0 12px; }
.wb p { font-size: 14.5px; line-height: 1.65; max-width: 600px; margin: 0; }
</style>
