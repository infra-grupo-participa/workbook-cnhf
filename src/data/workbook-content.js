// workbook-content.js — FONTE ÚNICA do Workbook de acompanhamento CNHF (schema v2)
    ...
    "paragrafos": [
      ...
      },
      {
        ...
        "blocos": [
          {
            "tipo": "prosa",
            "texto": "Controle e Holding são conceitos autônomos, e a distinção corresponde ao art."
          },
          {
            "tipo": "lacuna",
            "id": "cap-1-l1",
      ...
      },
      {
        ...
        "blocos": [
          ...
          {
            "tipo": "prosa",
            "texto": "e a doutrina distingue a holding pura, cujo objeto se limita à participação, da holding mista, que agrega atividade operacional própria. "
          }
        ]
      },
      {
        ...
        "blocos": [
          ...
          {
            "tipo": "prosa",
            "texto": "e não unidade de negócio autônoma. "
          }
        ]
      },
      {
        ...
        "blocos": [
          {
            "tipo": "prosa",
            "texto": "A designação \"empresa\" evoca operação, faturamento e funcionamento, atributos que não correspondem à natureza dessas sociedades; \"célula\" comunica componente funcional inserido em estrutura maior. Do exposto extrai-se a definição adotada:"
          },
          {
            "tipo": "lacuna",
            "id": "cap-1-l16",
    ...
    "paragrafos": [
      {
        ...
        "blocos": [
          {
            "tipo": "prosa",
            "texto": "O conceito, isoladamente, habilita ao debate acadêmico, não ao exercício profissional. Este pressupõe identificar as hipóteses concretas em que a Holding Familiar constitui solução adequada. Sistematizam-se sete, em ordem de atualidade. "
          }
        ]
      },
      {
        ...
        "blocos": [
          {
            "tipo": "prosa",
            "texto": "Tributação de dividendos. A Lei 9.250/95, alterada pela Lei 15.270/2025, passou a sujeitar à retenção na fonte os dividendos distribuídos a pessoa física."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocos": [
          {
            "tipo": "prosa",
            "texto": "A análise pode revelar configuração distinta, em que a concentração de despesa em unidade sujeita ao lucro real neutraliza a carga sobre aquela parcela. Não há configuração padrão: há análise, e da análise decorre desenho. "
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocos": [
          {
            "tipo": "prosa",
            "texto": "O vício que se afasta é estrutural: não depende da efetiva coligação, bastando sua possibilidade jurídica para comprometer a previsibilidade do arranjo, valor autônomo em estruturação patrimonial. "
          }
        ]
      },
      {
        ...
        "blocos": [
          {
            "tipo": "prosa",
            "texto": "Preservação de legado. Categoria de cliente cuja demanda é existencial: o empreendedor que construiu patrimônio significativo e se depara com a ausência de continuidade geracional. Constitui-se"
          },
          {
            "tipo": "lacuna",
            "id": "cap-2-l5",
      ...
      },
      {
        ...
        "blocos": [
          {
            "tipo": "prosa",
            "texto": "Opera-se uma reconstrução de premissa: a continuidade do legado não exige o exercício da atividade operacional, mas o exercício da condição de sócio, porque sócio é tomador de decisão, não operador. A hipótese aplica-se com particular intensidade a herdeiros radicados no exterior. "
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocos": [
          {
            "tipo": "prosa",
            "texto": "A Holding Familiar não é instrumento de subtração de patrimônio à execução em curso, não se presta a fraudar credores, e o profissional que assim a empregue incorre em ilícito. Ao devedor já constituído em mora, a solução são os instrumentos próprios de defesa. "
          }
        ]
      },
      {
        ...
        "blocos": [
          {
            "tipo": "prosa",
            "texto": "Supressão do inventário. É a aplicação que produz maior volume de contratação, porque o inventário atinge indistintamente todo titular de patrimônio. Seu custo real excede em muito o ITCMD:"
          },
          {
            "tipo": "lacuna",
            "id": "cap-2-l8",
    ...
    "paragrafos": [
      ...
      },
      {
        ...
        "blocos": [
          {
            "tipo": "prosa",
            "texto": "A doação de quotas não se confunde com a doação de bens do direito civil, que é irrevogável; ela se sujeita a regras próprias do direito societário que asseguram ao doador o direito de arrependimento, inexistente na doação civil. A estrutura opera segundo um sistema de gatilho:"
          },
          {
            "tipo": "lacuna",
            "id": "cap-5-l1",
      ...
      },
      {
        ...
        "blocos": [
          {
            "tipo": "prosa",
            "texto": "Ao lado das cláusulas civilistas, o sistema emprega instrumentos de direito societário, dos quais decorre a barreira de controle. "
          }
        ]
      },
      {
    ...
    "paragrafos": [
      ...
      },
      {
        ...
        "blocos": [
          {
            "tipo": "prosa",
            "texto": "A supressão de etapas produz, tecnicamente, lacuna oponível pelo Fisco ou fundamento de invalidade, e, operacionalmente, embaraço na fase subsequente cuja origem dificilmente se identifica; a dispensa da sessão de viabilidade sob o argumento de proximidade com o cliente confunde conhecimento pessoal com diagnóstico técnico. Cada etapa decompõe-se em"
          },
          {
            "tipo": "lacuna",
            "id": "extra-1-l1",
    ...
    "paragrafos": [
      ...
      },
      {
        ...
        "blocos": [
          {
            "tipo": "prosa",
            "texto": "Distinguem-se o fundo fechado, que não admite resgate a qualquer tempo, facultada a alienação da quota, e o fundo aberto, que admite o resgate e concentra a maior parte dos recursos. Tratando-se de aplicação financeira"
          },
          {
            "tipo": "lacuna",
            "id": "extra-3-l1",
